...
function windowResizeHandler() {
  ...
  circleRadius = (width > height ? height / 4 : width / 4);
  circleCenter = {
    x: width / 2,
    y: height / 2
  }
...
var Clock = (function() {
    var canvas,
        ...
        press = false, 
        quiver = true, 
        texts = ["buenas noches","mi niña?","queria decirte que....", "Estoy muy feliz..", "de haberte conocido...","todo estara bien mi niña","Y yo aqui estare...","Uy... mira....", "Una estrellita paso ahi....","Al final...", "tu y yo bajo el mismo cielo"," vdd?","dejare q vean las estrellas...","","te quiero..."],
        text = texts[0],
        textNum = 0,
        textSize = 60, 
        valentine = false, 
    ...
    var setDimensions = function() {
        ...
        canvas.width = window.innerWidth >= 900 ? 900 : width;
